...
export default function Page() {
  return (
    <div className="max-w-none border p-5">
      ...
      <ul>
        ...
        <li>
          Try using the browser&apos;s backwards and forwards navigation. Notice
          the browser&apos;s URL history state and active UI state is correctly
          synced.
        </li>
        <li>
      ...
      <div className="flex gap-2">
        <Link href="https://nextjs.org/docs/app/building-your-application/routing/parallel-routes">
          Docs
        </Link>

        <Link href="https://github.com/vercel/app-playground/tree/main/app/parallel-routes">
          Code
        </Link>
      </div>
    </div>
